      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <div className="glass p-6 rounded-xl border-l-4 border-l-primary">
            <p className="text-gray-400 text-sm">Live Active Users</p>
            <h2 className="text-4xl font-bold text-white mt-2 animate-pulse">{activeUsers}</h2>
        ...
        <div className="glass p-6 rounded-xl h-[400px]">
          <h3 className="text-lg font-semibold text-white mb-6">Weekly Traffic</h3>
