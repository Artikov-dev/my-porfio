    ...
    <section id="projects" className="py-32 px-6 relative max-w-6xl mx-auto text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16 text-left">
        <ScrollReveal delay={0.2}>
          <TiltCard>
            <div className="glass p-8 rounded-2xl h-[300px] flex flex-col justify-end relative overflow-hidden group cursor-pointer border border-white/10 hover:border-primary/50 transition-colors">
              ...
              <div className="relative z-20" style={{ transform: 'translateZ(50px)' }}>
                <h3 className="text-2xl font-bold text-white mb-2">E-Commerce Microservices</h3>
                <p className="text-gray-300">Node.js • Redis • Kubernetes</p>
              </div>
            </div>
          </TiltCard>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.4}>
          <TiltCard>
            <div className="glass p-8 rounded-2xl h-[300px] flex flex-col justify-end relative overflow-hidden group cursor-pointer border border-white/10 hover:border-primary/50 transition-colors">
              ...
              <div className="relative z-20" style={{ transform: 'translateZ(50px)' }}>
                <h3 className="text-2xl font-bold text-white mb-2">FinTech Analytics Dashboard</h3>
                <p className="text-gray-300">React • D3.js • WebSockets</p>
              </div>
            </div>
          </TiltCard>
        </ScrollReveal>
