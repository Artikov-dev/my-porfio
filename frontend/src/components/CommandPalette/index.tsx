      ...
      <div className="fixed inset-0 z-50 flex items-start justify-center pt-32 px-4 sm:px-0 bg-background/80 backdrop-blur-sm">
        ...
        >
          ...
          <div className="max-h-80 overflow-y-auto p-2">
            ...
            <button className="w-full flex items-center px-3 py-3 text-sm text-gray-300 hover:bg-white/5 hover:text-white rounded-md transition-colors text-left cursor-pointer">
