...
const seedProjects = async () => {
  try {
    ...
    const projects = [
      ...
      {
        title: {
          en: 'Taigo - Modern Web Platform',
          uz: 'Taigo - Zamonaviy Veb Platforma',
          ru: 'Taigo - Современная Веб-Платформа',
        },
        description: {
          en: 'A modern and intuitive digital platform built with cutting-edge web technologies for seamless performance and user engagement.',
          uz: "Yuqori tezlik va qulay foydalanuvchi interfeysiga ega ilg'or veb texnologiyalari asosida yaratilgan zamonaviy platforma.",
          ru: 'Современная цифровая платформа, созданная на передовых веб-технологиях для высокой производительности и удобства.',
        },
        image_url:
