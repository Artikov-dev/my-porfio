  ...
  static async getSettings() {
    ...
    if (result.rows.length === 0) {
      ...
      const defaultSettings = {
        title: { en: 'Roma Artikov | Portfolio', uz: 'Roma Artikov | Portfoli', ru: 'Рома Артиков | Портфолио' },
        description: { en: 'Full Stack Engineer based in Uzbekistan', uz: 'O\\'zbekistondagi Full Stack Muhandis', ru: 'Full Stack Инженер из Узбекистана' },
        keywords: ['Roma Artikov', 'Full Stack', 'Developer', 'Uzbekistan', 'React', 'Node.js'],
      ...
      result = await db.query(`
        ...
        VALUES (1, $1, $2, $3, $4)
        RETURNING *;
      `, [defaultSettings.title, defaultSettings.description, defaultSettings.keywords, defaultSettings.og_image]);
    }
